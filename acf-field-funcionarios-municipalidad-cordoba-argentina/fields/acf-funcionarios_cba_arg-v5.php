...
class acf_field_funcionarios_cba_arg extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('FIELD_LABEL', 'acf-funcionarios_cba_arg');
		...
		*  var message = acf._e('funcionarios_cba_arg', 'error');
		*/
		
		$this->l10n = array(
			'error'	=> __('Error! Please enter a higher value', 'acf-funcionarios_cba_arg'),
		);
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Font Size','acf-funcionarios_cba_arg'),
			'instructions'	=> __('Customise the input font size','acf-funcionarios_cba_arg'),
			'type'			=> 'number',
			'name'			=> 'font_size',
			'prepend'		=> 'px',
		));
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-funcionarios_cba_arg'),
		}
